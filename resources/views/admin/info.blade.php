...
@section('content')
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; System Info
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>Sydney时间</label><span><?php echo date('Y年m月d日 H时i分s秒')?></span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://www.xxx.com</a></span>
                </li>
                <li>
                    <label>官方交流QQ群：</label><span>111111111</span>
                </li>
            </ul>
        </div>
    </div>
